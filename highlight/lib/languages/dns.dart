...
final dns = Mode(refs: {}, aliases: [
  ...
  "keyword":
      "RP SOA TKEY SIG APL NSEC3PARAM LOC DS KX IN SRV CDNSKEY TLSA DNSKEY CERT CDS MX DNAME TA A AAAA TSIG TXT HIP SSHFP DHCID NSEC KEY DLV NSEC3 RRSIG AFSDB PTR NAPTR CNAME CAA IPSECKEY NS"
}, contains: [
  Mode(
      className: "comment",
      begin: ";",
